...
CREATE TABLE `client` (
  ...
  `doc_seria` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `doc_number` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `inn` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `add1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `client` VALUES ('2', 'Клиент', 'Клиентов', 'Клиентович', '1986-02-25', 'M', 'AB', '1234567', null, null, null, '3', '2020-12-17 09:16:29', '2020-12-17 09:28:26');
INSERT INTO `client` VALUES ('3', 'Жабборов', 'Аброр', '', '2006-01-01', 'M', '', '', null, null, null, '3', '2020-12-17 09:23:34', '2020-12-17 09:26:03');
INSERT INTO `client` VALUES ('4', 'Азиза', 'Муслимова', 'Жамшид кизи', '1995-04-03', 'F', 'AB', '2323232', null, null, null, '3', '2020-12-17 10:18:15', '2020-12-17 10:18:15');

-- ----------------------------
-- Table structure for `finish_payments`
-- ----------------------------
DROP TABLE IF EXISTS `finish_payments`;
CREATE TABLE `finish_payments` (
  `id` int NOT NULL,
...
-- ----------------------------
-- Records of finish_payments
-- ----------------------------
INSERT INTO `finish_payments` VALUES ('1', '2020-12-17 13:20:13', '4');
INSERT INTO `finish_payments` VALUES ('4', '2020-12-17 13:12:43', '4');
INSERT INTO `finish_payments` VALUES ('5', '2020-12-17 13:09:06', '4');
INSERT INTO `finish_payments` VALUES ('6', '2020-12-17 13:19:49', '4');
...
CREATE TABLE `pokaz_limits` (
  ...
  `indikator` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `indikator_value` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `norma` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `down_limit` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `up_limit` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `add1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `registration` (
  ...
  `add1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `add2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `registration` VALUES ('2', '2', '3', '95', '57000', '20000', null, '27000', null, null, null, '2020-12-17 09:16:29', '2020-12-17 09:16:29');
INSERT INTO `registration` VALUES ('3', '3', '3', '13', '21000', null, null, null, null, null, null, '2020-12-17 09:23:34', '2020-12-17 09:23:34');
INSERT INTO `registration` VALUES ('4', '3', '3', '13', '21000', '15000', '6000', null, null, null, null, '2020-12-17 09:26:03', '2020-12-17 09:26:03');
INSERT INTO `registration` VALUES ('5', '2', '3', '11', '24000', '24000', null, null, null, null, null, '2020-12-17 09:28:26', '2020-12-17 09:28:26');
INSERT INTO `registration` VALUES ('6', '4', '3', '98', '56000', '20000', '36000', null, null, null, null, '2020-12-17 10:18:15', '2020-12-17 10:18:15');
...
INSERT INTO `reg_dopinfo` VALUES ('5', '2', '214', '271');
INSERT INTO `reg_dopinfo` VALUES ('6', '6', '217', '290');
...
CREATE TABLE `result` (
  ...
  `pokaz_id` int DEFAULT NULL,
  `reslut_value` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `result_answer` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of result
-- ----------------------------
INSERT INTO `result` VALUES ('1', '1', '1', '1', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('2', '1', '1', '2', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('3', '1', '1', '3', '3', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('4', '1', '1', '4', '4', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('5', '1', '1', '5', '5', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('6', '1', '1', '6', '6', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('7', '1', '1', '7', '8', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('8', '1', '1', '8', '7', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('9', '1', '1', '9', '2.2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('10', '1', '1', '10', '2.6', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('11', '1', '1', '11', '20.6', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('12', '1', '1', '12', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('13', '1', '1', '13', '3', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('14', '1', '1', '14', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('15', '1', '1', '15', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('16', '1', '1', '16', '12', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('17', '1', '1', '17', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('18', '1', '1', '18', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('19', '1', '1', '19', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('20', '1', '1', '20', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('21', '1', '1', '21', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('22', '1', '1', '22', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('23', '1', '1', '23', '1', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('24', '1', '1', '24', '2', null, '2020-12-16 13:16:08', '2');
INSERT INTO `result` VALUES ('25', '6', '98', '217', null, null, null, null);
INSERT INTO `result` VALUES ('26', '5', '11', '68', '15', null, '2020-12-17 14:22:30', '2');
INSERT INTO `result` VALUES ('27', '4', '13', '70', null, null, null, null);
...
CREATE TABLE `role` (
  ...
  `group` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `add1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `lavozim` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `user` VALUES ('2', 'Фалончиев Пистончи', 'Лаборант', '4', '1', 'lab', 'lab', null, 'Лаборант тест', 'partner5.PNG', null, null);
INSERT INTO `user` VALUES ('3', 'Солибоев Жамшид', 'Старший регистратор', '2', '1', 'reg', 'reg', '+998945563311', '', 'uploads/1608181375-4-hona.jpg', null, null);
INSERT INTO `user` VALUES ('4', 'Базарбаев Мансур', 'Кассир', '3', '1', 'kassa', 'kassa', '+998975561178', '', '', null, null);
