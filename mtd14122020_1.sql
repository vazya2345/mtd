...
CREATE TABLE `client` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4_general_ci COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `s_analiz` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `price` int DEFAULT NULL,
  `is_active` tinyint DEFAULT NULL,
  `ord` int DEFAULT NULL,
  `desc` text CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci,
  `add1` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `group_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8mb4_general_ci COLLATE=utf8mb4_general_ci_unicode_ci;
...
CREATE TABLE `s_groups` (
  ...
  `title` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4_general_ci COLLATE=utf8mb4_general_ci_unicode_ci;
...
CREATE TABLE `vid_analiz` (
  ...
  `analiz_id` int NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `sec_text` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `type` int DEFAULT NULL,
  `ord` int DEFAULT NULL,
  `add1` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `ed_izm` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  `kolkach` varchar(255) CHARACTER SET utf8mb4_general_ci COLLATE utf8mb4_general_ci_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `analiz_id_fk` (`analiz_id`),
  CONSTRAINT `analiz_id_fk` FOREIGN KEY (`analiz_id`) REFERENCES `s_analiz` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4_general_ci COLLATE=utf8mb4_general_ci_unicode_ci;
